              ...
              <table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                  <td valign="top"  width="400">
                    ...
                    <a title="<%=rs("ProductName")%>"  class="cloud-zoom" rel="adjustX: 10, adjustY:-4"><img src="<%=HtmlSmallPic(rs("GroupID"),rs("BigPic"),rs("Exclusive"))%>" width="400" title="<%=rs("ProductName")%>" id="datu" style="border:1px #cccccc solid; padding:3px" border="0"></a><br />
                    <br />
                    <!-- <a href="ProductBuy.Asp?ProductNo=<%=rs("ProductNo")%>" title="立即订购：<%=rs("ProductName")%>"><img src="Images/buy.gif" border="0" /></a>-->
                    
                  </td>
                  <td valign="top" width="300" style="line-height:200%; padding-left:20px;">
                  
                  
 
                    <div style="width:300px; height:1px; padding:0px; margin:0px; overflow: hidden"></div>
